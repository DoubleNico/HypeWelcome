package me.doublenico.hypewelcome.files;
...
public class JoinCustomFile {

    private HypeWelcome plugin;
    private FileConfiguration levelConfig = null;
    private File configFile = null;
    private final String configName = "join_custom.yml";

    public JoinCustomFile(HypeWelcome plugin){
        this.plugin = plugin;
        saveDefaultConfig();
    }
